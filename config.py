...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://devenshkumar0753:Devenshk03@cluster0.kw2mbxf.mongodb.net/?retryWrites=true&w=majority")
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>𝗔𝗻𝗶𝗺𝗲 𝗶𝗻 𝗛𝗶𝗻𝗱𝗶</b>")
try:
    ADMINS=[]
